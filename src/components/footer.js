            ...
            <section class="bg-dark text-light">
                <div class="py-5 container">
                    <div class="row">
                        <div class="col-12">
                            <div class="lc-block">
                                <img class="img-fluid" alt="logo" src="${LOGO_DCGASKETS}" width="80"/> ${this.company} - ${this.year} <span class="i18nelement" data-i18n="key_footer_section_right_reserved">Derechos Reservados</span>. 
